        ...
        <div class="page-sidebar nav-collapse collapse" style="left: 0">
            <ul id="menuall" class="page-sidebar-menu">
                ...
                <li id="menupage6">
                    ...
                    <ul class="sub-menu">
                    <li id="menupage6_5">
                            <a href="Agent/AgentList.jsp?active=menupage6_5">商品列表</a>
                        </li> 
                        <li id="menupage6_6">
                    ...
                    <a href="javascript:;">
                     ...
                     <ul class="sub-menu">
                      <!--  <li id="menupage5_2">
                            <a href="Individual/Arrangement.jsp?active=menupage5_2">用户列表</a>
                        </li> -->
                        <!-- <li id="menupage5_1">
                            <a href="">工作记录</a>
                        </li> -->
                        ...
                        <li id="menupage5_1">
                            <a href="Achievement/AddAchieve.jsp?active=menupage5_1">业绩编辑</a>
                        </li>
                        <li id="menupage5_2">
